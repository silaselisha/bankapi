...
// Source: github.com/silaselisha/bankapi/database/sqlc (interfaces: Store)
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 database.ListTransfersParams) ([]database.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 database.TransferTxParams) (database.TransferTxResultsParams, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(database.TransferTxResultsParams)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
